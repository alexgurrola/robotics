...
public class StartupClientOnly
{
    public static void preInitClientOnly()
    {
        ...
        StateMapperBase ignoreState = new StateMapperBase()
        {
            ...
            {
                return new ModelResourceLocation("robotics:mbe05_block_3d_web_statemapper_name");
            }
        };
        ...
        ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("robotics:mbe05_block_3d_web", "inventory");
