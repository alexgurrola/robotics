...
public class StartupClientOnly
{
    ...
    {
        ModelResourceLocation itemBlockModelResourceLocation = new ModelResourceLocation("robotics:mbe13_item_tools_block", "inventory");
        ...
        ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("robotics:mbe13_item_tools_item", "inventory");
