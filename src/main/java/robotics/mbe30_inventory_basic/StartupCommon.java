package robotics.mbe30_inventory_basic;
...
import robotics.GuiHandlerRegistry;
...
public class StartupCommon
{
    ...
    public static void preInitCommon()
    {
         ...
         *          tile.robotics:mbe_30_inventory_basic.name
         */
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(Robotics.instance, GuiHandlerRegistry.getInstance());
