package robotics.mbe11_item_variants;
...
//    ModelBakery.addVariantName(StartupCommon.itemVariants,  "robotics:mbe11_item_variants_0pc",
//            "robotics:mbe11_item_variants_25pc",
//            "robotics:mbe11_item_variants_50pc",
//            "robotics:mbe11_item_variants_75pc",
//            "robotics:mbe11_item_variants_100pc"
//    );
        ...
        for (ItemVariants.EnumBottleFullness fullness : ItemVariants.EnumBottleFullness.values()) {
            ...
            ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("robotics:" + itemModelName, "inventory");
            // --> eg robotics:mbe11_item_variants_0pc, mbe11_item_variants_25pc, etc
