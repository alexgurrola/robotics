...
/*
   ...
   public class StartupCommon {
    ...
    java.lang.NoClassDefFoundError: net/minecraft/client/renderer/tileentity/TileEntitySpecialRenderer
  	at robotics.CommonProxy.preInit(CommonProxy.java:25) ~[CommonProxy.class:?]
...
public class Robotics
{
    ...
    public static Robotics instance;

    // Says where the client and server 'proxy' code is loaded.
    @SidedProxy(clientSide = "robotics.ClientOnlyProxy", serverSide = "robotics.DedicatedServerProxy")
     ...
     *
     * @param name
     * @return eg "robotics:myblockname"
     */
