package robotics.mbe06_redstone;

import net.minecraft.client.Minecraft;
import net.minecraft.client.renderer.block.model.ModelResourceLocation;
import net.minecraftforge.client.model.ModelLoader;
import net.minecraftforge.fml.client.registry.ClientRegistry;
import robotics.mbe06_redstone.input.LampColour;
import robotics.mbe06_redstone.input_and_output.TileEntityRedstoneMeter;
import robotics.mbe06_redstone.input_and_output.TileEntitySpecialRendererRedstoneMeter;
...
public class StartupClientOnly
{
    public static void preInitClientOnly()
    {
        ...
        ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("robotics:mbe06_block_redstone_variable_source", "inventory");
        ...
        ModelResourceLocation itemModelResourceLocationB = new ModelResourceLocation("robotics:mbe06b_block_redstone_target", "inventory");
        ...
        ModelResourceLocation itemModelResourceLocationC = new ModelResourceLocation("robotics:mbe06c_block_redstone_meter", "inventory");
        ...
        ModelResourceLocation itemModelResourceLocationD = new ModelResourceLocation("robotics:mbe06d_block_redstone_coloured_lamp", "inventory");
