...
public class RoboticsGuiFactory implements IModGuiFactory
{
    ...
    {
        return new RoboticsConfigGui(parentScreen);
    }
    ...
    public static class RoboticsConfigGui extends GuiConfig
    {
        public RoboticsConfigGui(GuiScreen parentScreen)
        {
            //I18n function basically "translates" or localizes the given key using the appropriate .lang file
            super(parentScreen, getConfigElements(), Robotics.MODID,
        ...
        private static List<IConfigElement> getConfigElements()
        {
            ...
            list.add(new DummyCategoryElement("miscCfg", "gui.configuration.ctgy.other", CategoryEntryOther.class));
            return list;
        }
        ...
        public static class CategoryEntryGeneral extends CategoryEntry
        {
            ...
            protected GuiScreen buildChildScreen()
            {
                ...
                Configuration configuration = RoboticsConfiguration.getConfig();
                ConfigElement cat_general = new ConfigElement(configuration.getCategory(RoboticsConfiguration.CATEGORY_NAME_GENERAL));
                ...
                return new GuiConfig(this.owningScreen, propertiesOnThisScreen,
                        ...
                        RoboticsConfiguration.CATEGORY_NAME_GENERAL,
        ...
        public static class CategoryEntryOther extends CategoryEntry
        {
            ...
            {
                Configuration configuration = RoboticsConfiguration.getConfig();
                ConfigElement cat_general = new ConfigElement(configuration.getCategory(RoboticsConfiguration.CATEGORY_NAME_OTHER));
                List<IConfigElement> propertiesOnThisScreen = cat_general.getChildElements();
                String windowTitle = configuration.toString();

                return new GuiConfig(this.owningScreen, propertiesOnThisScreen,
                        this.owningScreen.modID,
                        RoboticsConfiguration.CATEGORY_NAME_OTHER,
                        this.configElement.requiresWorldRestart() || this.owningScreen.allRequireWorldRestart,
                        this.configElement.requiresMcRestart() || this.owningScreen.allRequireMcRestart,
                        windowTitle);
                //this is a complicated object that specifies the category's gui screen, to better understand
