 ...
 * 3) in the RoboticsConfiguration variables (fields), as native values (integer, double, etc).
 * <p>
 * Setup:
 * (1) During your mod preInit(), call RoboticsConfiguration.preInit() to:
 ...
 */
public class RoboticsConfiguration
{
    ...
    public static void preInit()
    {
         ...
         */
        File configFile = new File(Loader.instance().getConfigDir(), "Robotics.cfg");
    ...
    /**
     * save the RoboticsConfiguration variables (fields) to disk
     */
    ...
    private static void syncConfig(boolean loadConfigFromFile, boolean readFieldsFromConfig)
    {
        ...
        propMyInt.setLanguageKey("gui.configuration.myInteger");
        ...
        propMyBool.setLanguageKey("gui.configuration.myBoolean").setRequiresMcRestart(true);
        ...
        propMyDouble.setLanguageKey("gui.configuration.myDouble");
        ...
        propMyString.setLanguageKey("gui.configuration.myString").setRequiresWorldRestart(true);
        ...
        propMyIntList.setLanguageKey("gui.configuration.myIntList");
        ...
        propColour.setLanguageKey("gui.configuration.myColour").setRequiresWorldRestart(true);
    ...
    public static class ConfigEventHandler
    {
        ...
        {
            if (Robotics.MODID.equals(event.getModID()) && !event.isWorldRunning()) {
